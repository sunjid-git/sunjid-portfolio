    ...
    return (
        ...
        <div className="container text-center aboutSection">
            <div className="text-box">
                ...
                <div>
                    <a href="https://github.com/sunjid-git" target="_blank">
                    <FontAwesomeIcon icon={faGithub} className="socialIcon" /> 
                    </a>
                    
                    <a href="https://www.linkedin.com/in/sunjid-in/"  target="_blank">
                    <FontAwesomeIcon icon={faLinkedin} className="socialIcon"/>
                    </a>
                     
                     <a href="https://www.facebook.com/sunjid.info/"  target="_blank">
